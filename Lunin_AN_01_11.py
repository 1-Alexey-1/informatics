...
#Задание3 It would be interesting to see if there is any evidence of a link between vaccine effectiveness and sex of the child.
...
import pandas as pd
df=pd.read_csv(r'C:\Users\sapfi\informatics\NISPUF17.csv',index_col=0)
df.head()
